...
const voteTpl = fse.readFileSync(pathTool.join(__dirname, './templates/vote-release.tpl'), 'utf-8');
const voteResultTpl = fse.readFileSync(pathTool.join(__dirname, './templates/vote-result.tpl'), 'utf-8');
const announceTpl = fse.readFileSync(pathTool.join(__dirname, './templates/announce-release.tpl'), 'utf-8');
