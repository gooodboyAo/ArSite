$(function () {
  ...
  QUnit.test('should sanitize templates by removing disallowed tags', function (assert) {
  ...
  QUnit.test('should sanitize templates by removing disallowed attributes', function (assert) {
    if (!document.implementation || !document.implementation.createHTMLDocument) {
      assert.expect(0)
  ...
  QUnit.test('should sanitize templates by removing tags with XSS', function (assert) {
    if (!document.implementation || !document.implementation.createHTMLDocument) {
      assert.expect(0)
